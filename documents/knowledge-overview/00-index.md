...
> **Purpose**: High-level summary, table of contents, and cross-references for the BoomOpen Workflow Kit project knowledge base
...
Built with Node.js >=18.0.0 using only built-in modules (fs, path, os, readline), BoomOpen Workflow Kit has zero production dependencies. The project also includes a React 19 + Vite + Tailwind CSS v4 marketing website deployed on Vercel, and uses semantic-release with conventional commits for automated npm publishing.
...
| npm | https://www.npmjs.com/package/@namch/boomopen-workflow-kit |
