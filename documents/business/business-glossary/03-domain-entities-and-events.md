# BoomOpen Workflow Kit — Domain Entities and Events

| Field | Value |
|-------|-------|
| **Purpose** | Entity vocabulary, event vocabulary, and entity-event interaction matrix for the boomopen-workflow-kit domain model |
