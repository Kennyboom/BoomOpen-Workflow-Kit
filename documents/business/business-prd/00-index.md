# BoomOpen Workflow Kit — Product Requirements Document (PRD)

> **Purpose**: PRD summary, table of contents, key facts, cross-references, and known gaps for @namch/boomopen-workflow-kit v1.3.0
