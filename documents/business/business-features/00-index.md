# BoomOpen Workflow Kit — Business Features (MoSCoW)

> **Purpose**: Features summary, table of contents, key facts, cross-references, and known gaps for @namch/boomopen-workflow-kit v1.3.0
